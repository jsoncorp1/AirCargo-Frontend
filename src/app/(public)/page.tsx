...
export default function HomePage() {
  ...
  return (
    <div className="bg-[#f4f4f4] min-h-screen font-sans text-gray-800 antialiased">
      ...
      {/* TARJETAS FLOTANTES (Overlapping the hero) */}
      <section className="relative z-20 container mx-auto px-4 -mt-16 md:-mt-24 mb-16">
        <div className="max-w-5xl mx-auto bg-white rounded-xl shadow-[0_15px_40px_rgba(0,0,0,0.1)] border border-gray-100 grid grid-cols-1 md:grid-cols-3 overflow-hidden">
          ...
          {/* Card 1 */}
          <Link href="/signin" className="group p-8 text-center border-b md:border-b-0 md:border-r border-gray-100 hover:bg-gray-50 transition-colors flex flex-col items-center">
            <div className="text-brand-600 mb-4 transform group-hover:scale-110 transition-transform">
              <svg className="w-12 h-12 mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z" /></svg>
            </div>
            <h3 className="font-bold text-gray-900 text-xl mb-2">Crear un Envío</h3>
      ...
      {/* NUESTROS SERVICIOS (Imágenes Completas / Adecuadas) */}
