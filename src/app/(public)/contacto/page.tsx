    ...
    <div className="bg-white rounded-xl shadow-xl border border-gray-100 p-6 md:p-10">
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="flex justify-end gap-4 border-t pt-8">
          <Link href="/" className="px-8 py-3 bg-white border border-gray-300 text-gray-700 font-bold rounded transition-colors shadow-sm hover:bg-gray-50">
            Cancelar
          </Link>
          <button
            type="submit"
            ...
            className="px-12 py-3 bg-brand-600 hover:bg-brand-700 disabled:bg-gray-300 disabled:text-gray-500 disabled:cursor-not-allowed text-white font-bold rounded transition-colors shadow-md uppercase tracking-wide"
          >
