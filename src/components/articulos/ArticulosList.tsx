...
interface ArticulosListProps {
  ...
  onView: (art: ArticuloLocal) => void;
  onEdit: (art: ArticuloLocal) => void;
  onDelete: (art: ArticuloLocal) => void;
}
        ...
        <Table>
          ...
          <TableBody className="divide-y divide-gray-100 dark:divide-gray-800">
            {loading ? (
              ...
              <TableRow>
                <TableCell className="px-5 py-20 text-center" colSpan={6}>
                  <div className="flex flex-col items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm font-semibold text-gray-700 dark:text-gray-300">No se encontraron artículos</p>
                      <p className="text-xs text-gray-500 mt-1 dark:text-gray-400">Ajusta los filtros de búsqueda o registra un nuevo artículo.</p>
                    </div>
                  </div>
                </TableCell>
              </TableRow>
              ...
              articulos.map((art) => (
                <TableRow key={art.id} className="hover:bg-gray-50/50 dark:hover:bg-white/[0.02] transition-colors">
                  <TableCell className="px-5 py-4">
