...
const navItems: NavItem[] = [
  {
    icon: <BoxCubeIcon />,
    // Ya no son solo entregas: el conductor también sale a buscar paquetes.
    name: "Mis Tareas",
...
const ConductorSidebar: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        <Link href="/conductor/envios" className="flex items-center gap-2 transition-transform duration-300 ease-in-out group-hover:scale-105">
