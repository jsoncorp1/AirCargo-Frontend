...
import { BoxIcon, PageIcon, BoxCubeIcon, HorizontaLDots } from "../icons/index";
...
const SupplierSidebar: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        <Link href="/proveedor/ordenes" className="flex items-center gap-2 transition-transform duration-300 ease-in-out group-hover:scale-105">
